...
The tests cover evaluator behavior, SQL safety validation, cron parsing, scheduler classification, scheduled execution dispatch, ad hoc execution behavior, saved-rule endpoint behavior, manual saved-rule execution, saved-rule result retrieval, Platform Intelligence routing, profiling utilities, query planning, rule sanitization, anomaly detection helpers, and orchestration dependency resolution.
